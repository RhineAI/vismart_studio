...
<div class="col-md-12 p-2 mb-3" style="background-color: white;">
    <div class="box">
        ...
        <div class="box-body">
           <div class="col-lg-5">
               <form action="{{ route('advantage.update', $previllege->id) }}" method="post" enctype="multipart/form-data">
                @method('put')
                ...
                @csrf
                    <div class="mb-2">
                        ...
                        @if($previllege->image)
                            <img src="{{ asset('storage/' . $previllege->image) }}" class="img-preview img-fluid my-3 col-sm-5 d-block">
                        @else
