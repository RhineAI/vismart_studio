    ...
    <div class="col-md-12 p-2 my-3" style="background-color: white">
        ...
        <div class="box">
            <div class="box-header with-border mx-2">
                <h2 class="mb-5">Detail Jasa</h2>
                <a href="/dashboard/layanan/detail_layanan_jasa/create" class="btn btn-outline-dark mb-3 p-2">
                    Tambah Baru
                ...
                <table class="table table-bordered table-package">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-center table-default" style="color:black;">Jasa</th>
