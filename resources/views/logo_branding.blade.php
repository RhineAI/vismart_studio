    ...
    <div class="container">
        <div class="row text-center align-items-center justify-content-center" style="min-height: 100vh">
            <div class="col-12">
                ...
                <h1 class="mt-5 mb-3 fw-bold">Now Managing Instagram Business is Easier Without Having a Team, Thinking
                    About Content and Design</h1>
...
<section class="column-3" id="column-3">
  <div class="container">
      <div class="row justify-content-around text-center">
          <h1 class="fw-bold my-5">Mengapa Anda Harus Menggunakan Jasa Logo dan Branding dari Vismart Studio</h1>
...
<section class="column-3" id="column-3">
  <div class="container">
      <div class="row justify-content-center text-center">
          <h1 class="fw-bold my-5">Layanan Jasa Desain Logo</h1>
          <div class="col-lg-4 col-md-6 p-5">
