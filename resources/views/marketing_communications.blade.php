        ...
        <div class="container"><a href="/" class="navbar-brand text-uppercase ms-2"><img src="/img/logo vismart studio.png" class="img-fluid" alt="..." style="width: 5em;"></a>
            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item ms-2"><a href="#page-2" class="nav-link text-uppercase">Info</a></li>
                    ...
                    <li class="nav-item ms-2"><a href="#pricing" class="nav-link text-uppercase">Pricing</a></li>
