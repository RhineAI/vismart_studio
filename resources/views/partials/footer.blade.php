          ...
          <div class="">
              ...
              <div class="row">
                  ...
                  <div class="col-md-3 col-lg-3 col-xl-3 mx-auto my-5">
                      ...
                      <p>
                          Kami adalah tim kreatif dari PT <a href="https://madtive.com/" style="color: #fff"
                              class="fw-bold">Madtive Studio</a> Indonesia yang didirikan sejak tahun 2015 yang sudah
                          bekerjasama dengan banyak clients mulai dari UMKM, Perusahaan menengah keatas hingga
                          pemerintahan.
                      </p>
                  </div>
                  <!-- Grid column -->
          ...
          <div class="p-3 pt-0">
              <div class="row d-flex align-items-center">
                  ...
                  <div class="col-md-5 col-lg-4 ml-lg-0 text-center text-md-end">
                      <!-- Facebook -->
                      <a href="https://www.facebook.com/Madtive" class="btn badge-primary btn-floating m-1"
                          class="text-white" role="button"><i class="fab fa-facebook-f"></i></a>

                      <!-- Twitter -->
                      <a href="https://twitter.com/madtive_studio" class="btn badge-primary btn-floating m-1"
                          class="text-white" role="button"><i class="fab fa-twitter"></i></a>

                      <!-- Google -->
                      <a href="https://madtive.com/" class="btn badge-primary btn-floating m-1" class="text-white"
                          role="button"><i class="fab fa-google"></i></a>

                      <!-- Instagram -->
                      <a href="https://www.instagram.com/madtive_studio/" class="btn badge-primary btn-floating m-1"
